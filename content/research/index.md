...
sections:
  ...
  - block: markdown
    content:
      ...
      text: |
        <div style="display:flex; flex-wrap:wrap; gap:2.5em; align-items:center; margin:1.5em 0;">
          ...
          <div style="flex:1; min-width:280px; max-width:480px;">
            <img src="/media/topic_1.png" alt="Machine Learning & AI" style="width:100%; border-radius:8px; box-shadow:0 4px 16px rgba(0,0,0,0.1);">
          </div>
        </div>
    design:
      columns: '1'
  ...
  - block: markdown
    content:
      title: Optimisation & Control
      text: |
        <div style="display:flex; flex-wrap:wrap; gap:2.5em; align-items:center; margin:1.5em 0;">
          <div style="flex:1; min-width:280px; max-width:480px;">
            <img src="/media/topic_2.png" alt="Optimisation & Control" style="width:100%; border-radius:8px; box-shadow:0 4px 16px rgba(0,0,0,0.1);">
          </div>
          <div style="flex:1; min-width:280px;">
    ...
    content:
      ...
      text: |
        <div style="display:flex; flex-wrap:wrap; gap:2.5em; align-items:center; margin:1.5em 0;">
          ...
          <div style="flex:1; min-width:280px; max-width:480px;">
            <img src="/media/topic_3.png" alt="AI for Science" style="width:100%; border-radius:8px; box-shadow:0 4px 16px rgba(0,0,0,0.1);">
          </div>
        </div>
    design:
      columns: '1'
  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        [Bubble Analyser](https://www.bubbleanalyser.com/) is an open-source tool for bubble size measurement from images, developed for froth flotation research. It provides automated image segmentation and size distribution analysis.

        - **Website:** [www.bubbleanalyser.com](https://www.bubbleanalyser.com/)
        - **Publication:** [Mesa, Quintanilla & Reyes, *Minerals Engineering* (2022)](https://www.sciencedirect.com/science/article/pii/S0892687522001078)
    design:
      columns: '1'
